...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_22 ) = {
	.len=19,
	.data={0x04,0x18,0x00,0xf9,0x52,0x7a,0xc8,0xb8,0x95,0x07,0x86,0xdd,0x46,0x5e,0xd4,0x36,0x6a,0xc4,0xa8,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_20 ) = {
	.len=19,
	.data={0x04,0x16,0x00,0xd9,0xe3,0x11,0xc4,0x72,0x05,0xf6,0x9d,0x5e,0x45,0xd9,0x50,0x31,0xcf,0x99,0x11,}
};
uint8_t bg_gattdb_attribute_field_19_data[1]={0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_18 ) = {
	.len=19,
	.data={0x04,0x14,0x00,0x99,0x70,0xe0,0x56,0x2f,0xb8,0xbf,0xae,0xf7,0x4a,0xae,0x2e,0x7f,0xac,0xe6,0xa6,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_16 ) = {
	.len=19,
	.data={0x04,0x12,0x00,0x02,0x03,0xf0,0xc8,0x6f,0x04,0x27,0x95,0x72,0x4f,0x39,0x0d,0xbc,0x57,0xca,0x91,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_attributes_map[])={
    ...
    {.uuid=0x000b,.permissions=0x04,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_14},
    ...
    {.uuid=0x8001,.permissions=0x04,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_17},
    {.uuid=0x0002,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_18},
    {.uuid=0x8002,.permissions=0x04,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_19},
    {.uuid=0x0002,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_20},
    {.uuid=0x8003,.permissions=0x04,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_21},
    {.uuid=0x0002,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_22},
    {.uuid=0x8004,.permissions=0x04,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_23},
};
...
GATT_DATA(const uint8_t bg_gattdb_adv_uuid16_map[])={0x02, 0x18, };
