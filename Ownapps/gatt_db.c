...
uint8_t bg_gattdb_attribute_field_31_data[21];
GATT_DATA(const struct bg_gattdb_attribute_chrvalue	bg_gattdb_attribute_field_31 ) = {
	.properties=0x10,
	.index=5,
	.max_len=20,
	.data_varlen=(struct bg_gattdb_buffer_with_len*)bg_gattdb_attribute_field_31_data,
};

GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_30 ) = {
	.len=19,
	.data={0x10,0x20,0x00,0x6e,0xdf,0xe3,0xfb,0x3c,0xb6,0xfa,0x9a,0xf9,0x4d,0xac,0xa5,0x02,0x91,0xde,0x53,}
};
...
uint8_t bg_gattdb_attribute_field_28_data[1]={0x00,};
GATT_DATA(const struct bg_gattdb_attribute_chrvalue	bg_gattdb_attribute_field_28 ) = {
	.properties=0x0a,
	.index=4,
	.max_len=1,
	.data=bg_gattdb_attribute_field_28_data,
};

GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_27 ) = {
	.len=19,
	.data={0x0a,0x1d,0x00,0x6b,0x24,0x03,0x62,0x57,0x5b,0xc6,0xb5,0x92,0x48,0xe7,0xae,0x08,0x2b,0x40,0xc5,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_attributes_map[])={
    ...
    {.uuid=0x0000,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_26},
    {.uuid=0x0002,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_27},
    {.uuid=0x8003,.permissions=0x03,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_28},
    {.uuid=0x000f,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_29},
    {.uuid=0x0002,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_30},
    {.uuid=0x8004,.permissions=0x00,.datatype=0x02,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_31},
    {.uuid=0x0010,.permissions=0x07,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x05}},
    {.uuid=0x000f,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_33},
};
