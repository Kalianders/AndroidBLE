...
uint8_t bg_gattdb_attribute_field_14_data[2]={0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_13 ) = {
	.len=19,
	.data={0x12,0x0f,0x00,0x65,0xd0,0x4f,0xb1,0xc4,0xb7,0x62,0xa5,0xb9,0x4b,0xc2,0x8a,0xe9,0xec,0xb9,0x82,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_attribute_field_2 ) = {
	.len=15,
	.data={0x42,0x47,0x4d,0x31,0x31,0x31,0x20,0x41,0x44,0x43,0x20,0x74,0x65,0x73,0x74,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x01,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_attribute_field_14},
    {.uuid=0x000b,.permissions=0x07,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x00}},
    {.uuid=0x000a,.permissions=0x01,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_attribute_field_16},
};
